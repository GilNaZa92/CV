...
<head>
    ...
    <!-- Chosen Palette: Dark & Calming Neutrals -->
    <!-- Application Structure Plan: The application is designed as a single-page portfolio with a sticky top navigation for easy access to key sections: Summary, Experience, Skills, and Education. The core is the 'Experience' section, which features an an interactive vertical timeline. Clicking a role on the timeline dynamically updates a content panel, breaking down a dense career history into manageable, user-selected segments. This non-linear, interactive approach is more engaging than a static document and allows recruiters to quickly access the most relevant information. A skills dashboard with a bar chart provides a quick visual summary of technical strengths. This structure was chosen to enhance user experience, highlight key achievements, and present the information in a modern, digestible format. -->
    <!-- Visualization & Content Choices: 
        - Professional Summary: Goal: Inform -> Method: Clean text block -> Interaction: None -> Justification: Provides a clear, immediate introduction to the candidate's profile.
        - Work Experience: Goal: Explore Change/History -> Method: Interactive Timeline (HTML/CSS) + Dynamic Content Panel -> Interaction: On-click updates of job details -> Justification: Transforms a linear list into an engaging, explorable career journey, preventing information overload. -> Library: Vanilla JS.
        - Skills Overview: Goal: Compare/Organize -> Method: Horizontal Bar Chart -> Interaction: Tooltips on hover -> Justification: Visually quantifies and categorizes technical abilities, offering a more impactful and quicker understanding than a simple list. -> Library: Chart.js.
        - Certifications: Goal: Inform -> Method: Styled "badges" or cards -> Interaction: None -> Justification: Visually separates and highlights key qualifications. -> Library: HTML/Tailwind CSS.
        - Education: Goal: Inform -> Method: Simple cards -> Interaction: None -> Justification: Clear and concise presentation for academic background. -> Library: HTML/Tailwind CSS. -->
    <style>
        body {
        ...
        const experienceData = [
            ...
            },
            {
                ...
                details: [
                    ...
                    'Monitored warranties and designed solutions to prevent recurring issues.',
